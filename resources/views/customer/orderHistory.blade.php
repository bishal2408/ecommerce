                              ...
                              <div class="row d-flex justify-content-center align-items-center h-100">
                                <div class="col-10">
                                  ...
                                  <div class="d-flex justify-content-between align-items-center mb-4">
                                    <h3 class="fw-normal mb-0 text-black">Your Orders History ({{ $order_count }}-items)</h3>
                                    <a href="{{ route('customer.clear.history') }}" class="text-decoration-none text-danger">
                                        <h5 class="font-xs" id="history-clear-all">Clear All</h5>
                                    </a>
                                  </div>
                                    ...
                                    <div class="card rounded-3 mb-4 shadow">
                                        ...
                                        <div class="row d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                                <form action="{{ route('customer.item.deleteHistory', ['order'=>$order->id]) }}" class="d-flex" method="POST">
                                                    @method('DELETE')
                                                    @csrf
